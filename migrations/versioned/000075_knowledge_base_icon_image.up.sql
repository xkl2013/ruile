...
-- Description: Allow knowledge base icons to store uploaded image references.
...
COMMENT ON COLUMN knowledge_bases.icon IS
    'Knowledge base display icon (TDesign icon name, emoji prefix, or image storage/url prefix).';
