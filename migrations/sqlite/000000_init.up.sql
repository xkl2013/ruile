...
CREATE TABLE IF NOT EXISTS tenant_members (
    ...
    work_profile_description TEXT NOT NULL DEFAULT '',
    expires_at DATETIME,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_user_work_profiles_default
    ON user_work_profiles(tenant_id, user_id)
    WHERE default_profile = 1 AND deleted_at IS NULL;
...
CREATE TABLE IF NOT EXISTS service_reminders (
    ...
    memory_signals TEXT NOT NULL DEFAULT '[]',
    source_memory_ids TEXT NOT NULL DEFAULT '[]',
    source_memory_count INTEGER NOT NULL DEFAULT 0,
    last_memory_at DATETIME,
    confidence REAL NOT NULL DEFAULT 0,
    sales_highlights TEXT NOT NULL DEFAULT '[]',
