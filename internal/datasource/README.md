# 睿乐大脑 Data Source Sync Framework

## Overview

The data source sync framework enables 睿乐大脑 to automatically import and synchronize content from external platforms (Feishu, Notion, Confluence, etc.) into knowledge bases. This is the foundational layer upon which all specific connectors are built.
