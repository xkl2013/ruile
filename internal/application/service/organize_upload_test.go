...
func (s *stubOrganizeFileService) GetFile(context.Context, string) (io.ReadCloser, error) { return nil, nil }
...
func (s *stubOrganizeFileService) CopyFile(context.Context, string, uint64, string) (string, error) { return "", nil }
...
func (s *stubOrganizeModelService) ClearModelCredential(context.Context, string, string) error { return nil }
...
func (s *stubOrganizeModelService) GetVLMModel(context.Context, string) (vlm.VLM, error) { return nil, nil }
func (s *stubOrganizeModelService) GetOCRModel(context.Context, string) (vlm.VLM, error) { return nil, nil }
