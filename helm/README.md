...
Helm chart for deploying [睿乐大脑](https://github.com/Tencent/WeKnora) - an AI-powered Knowledge RAG Platform.

## Overview

睿乐大脑 is an intelligent knowledge base platform that combines:
