...
\
  ...
  organization: {
    ...
    settings: {
      ...
      membersDesc: 'View and manage space members and their roles. Each member represents a workspace — all users in the same workspace share access to this space.',
  ...
  tenantMember: {
    title: 'Members',
    sectionDescription:
      'Invite teammates to the workspace and manage their roles. Owners and Admins can manage ordinary members; Owner-role changes are limited to Owners or system admins.',
    ...
    create: {
      ...
      submit: 'Create',
      success: 'Member created. Default password: {password}',
    },
    remove: {
      button: 'Remove',
    ...
    audit: {
      tabLabel: 'Audit log',
      description:
        'Records every membership change and access denial in this workspace. Newest first. Repeated denials within a minute are deduplicated.',
      refresh: 'Refresh',
      loadMore: 'Load older',
      end: 'End of log.',
      ...
      action: {
        ...
        'rbac.member_suspended': 'Member suspended',
        'rbac.member_reactivated': 'Member reactivated',
