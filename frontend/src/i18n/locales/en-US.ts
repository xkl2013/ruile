export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and 睿乐大脑 parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  resourceOrigin: {
    ...
    shared: 'External',
    sharedTooltip: 'Accessed from an external workspace via a team space'
  },
  knowledgeBase: {
    ...
    videosFilteredNoVLM: 'Skipped {count} video file(s)',
    ...
    uploadFileDesc: 'Supports PDF, Word, TXT, images, audio, video, etc.',
    ...
    regenerateSummarySubmitted: 'Summary rebuild task submitted',
    regenerateSummaryFailed: 'Summary rebuild failed. Please try again later',
    regenerateSummaryInProgress: 'Summary is already being generated. Please try again later',
    ...
    deleteDirectoryConfirm: 'Delete the "{path}" directory configuration? Files will not be deleted.',
    deleteDirectoryConfirmWithChildren: 'Delete "{path}" and its {count} subdirectory configurations? Files will not be deleted.',
    createSubdirectoryTitle: 'Add subdirectory',
    directorySettingsTitle: 'Directory settings',
    editDirectoryTitle: 'Edit directory',
    parentDirectory: 'Parent directory',
    directoryName: 'Directory name',
    directoryNamePlaceholder: 'Enter directory name',
    directoryDescription: 'Directory description',
    directoryDescriptionPlaceholder: 'Enter directory description',
    directoryNameRequired: 'Enter a directory name',
    directoryNameInvalid: 'Directory name cannot contain / or \\',
    directoryDuplicate: 'Directory already exists',
    directoryCreateSuccess: 'Directory added',
    directorySaveSuccess: 'Directory settings saved',
    directoryDeleteSuccess: 'Directory deleted',
    columnName: 'Name',
    columnTag: 'Tag',
    columnSize: 'Size',
    columnType: 'Type',
  ...
  uploadConfirm: {
    ...
    asrModelRequired: 'This batch includes audio or video. Enable ASR and select a speech recognition model.',
    asrRequiredForAudio: 'Off (batch includes audio/video)',
  ...
  settings: {
    ...
    workProfile: {
      title: 'Work Profile',
      description: 'Set the work-profile description for the current workspace to clarify your responsibilities and service boundaries.',
      fieldLabel: 'Work-profile description',
      fieldDescription: 'Describe your responsibilities, service audience, and boundaries in one short paragraph.',
      placeholder: 'For example: Handle admissions inquiries, parent communication, and course follow-up while supporting education-focused knowledge organization.',
      empty: 'No work-profile description yet',
      edit: 'Edit',
      save: 'Save',
      cancel: 'Cancel',
      saved: 'Work-profile description saved',
      loadFailed: 'Failed to load work-profile description',
      saveFailed: 'Failed to save work-profile description',
      required: 'Enter a work-profile description',
      noWorkspace: 'There is no workspace available to edit',
      promptLabel: 'AI-generated work profile',
      promptDescription: 'Describe the role, service audience, focus, or other requirements. AI will prepare an editable profile.',
      promptPlaceholder: 'For example: I am an admissions consultant for a kindergarten. I handle parent inquiries, trial-class scheduling, and enrollment follow-up.',
      generate: 'Generate with AI',
      generating: 'Generating...',
      promptRequired: 'Enter a prompt first',
      generateFailed: 'Failed to generate the work profile',
      generated: 'A draft was generated. Review it and save when ready.',
    },
    navGroups: {
      account: 'Account',
      workspace: 'Workspace',
    ...
    weknoraCloud: {
      title: '睿乐大脑云',
      description: 'Configure 睿乐大脑云 APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: '睿乐大脑云 credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: '睿乐大脑云 application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: '睿乐大脑云 application secret',
      ...
      credentialConfigured: '睿乐大脑云 credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: '睿乐大脑云 credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: '睿乐大脑云 credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard 睿乐大脑云 models for chat, retrieval, reranking, and vision.',
  ...
  auth: {
    ...
    otherLoginMethod: 'Other sign-in methods',
    loginWithCode: 'Sign in with code',
    smsLoginHint: 'Use the SMS verification code to sign in. Password login stays available as a fallback.',
    smsLoginUnavailable: 'SMS login is temporarily unavailable. Use another sign-in method.',
    verificationCode: 'Verification code',
    codePlaceholder: 'Enter verification code',
    codeRequired: 'Enter verification code',
    codeInvalid: 'Enter a 4-8 digit verification code',
    sendCode: 'Send code',
    sendingCode: 'Sending...',
    codeSent: 'Verification code sent',
    codeSendFailed: 'Failed to send verification code',
    codeResendIn: 'Resend in {seconds}s',
    register: 'Register',
    ...
    loginError: 'Login error, please check phone number, code, or password',
    ...
    workspaceOnboarding: {
      title: 'Initializing account workspace',
      description: 'The system creates a personal workspace automatically when the account is created. If this page stays open, reload or contact an administrator.',
      create: 'Reload',
      invitations: 'View shared access',
      help: 'Employees do not need to accept invitations or choose an organization; authorized knowledge bases appear under Shared with me after login.',
      ...
      inviteOnlyDescription: 'Account workspaces are created automatically in the background; employee shared access is available after login.',
      inviteOnlyNotice: 'Workspaces are created automatically in the background; no manual creation or invitation acceptance is needed',
  ...
  createChat: {
    title: 'Hi, I am 睿乐大脑 — your knowledge, within reach',
  ...
  knowledgeList: {
    ...
    scope: {
      ...
      enterprise: 'Enterprise knowledge base',
      subscribed: 'Subscribed knowledge base',
    },
    ...
    empty: {
      ...
      subscribedTitle: 'No subscribed knowledge bases',
      subscribedDescription: 'Subscribed knowledge bases that you can still access will appear here',
    },
    delete: {
  ...
  embedPublish: {
    ...
    webhookUrlDesc: 'Optional. 睿乐大脑 POSTs message_sent / message_received events to this HTTPS endpoint.',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      iconImageInvalid: 'Choose an image file',
      iconImageTooLarge: 'Image must be {size}MB or smaller',
      iconImageProcessFailed: 'Failed to process image',
      ...
      createScopeLabel: 'Knowledge Base Scope',
      createScopeDescription: 'Choose where this knowledge base is managed. Personal knowledge bases are private; enterprise knowledge bases are managed in the enterprise workspace.',
      createScopePersonal: 'Personal Knowledge Base',
      createScopeEnterprise: 'Enterprise Knowledge Base',
      enterpriseTargetLabel: 'Enterprise Workspace',
      enterpriseTargetPlaceholder: 'Select an enterprise workspace',
      enterpriseTargetRequired: 'Select an enterprise workspace',
...
\
    ...
    asr: {
      ...
      description:
        'Configure ASR (speech-to-text). When enabled, you can upload audio or video files and transcribe them to text (e.g. mp3, wav, m4a, flac, ogg, mp4, mov, webm).',
  ...
  tenant: {
    ...
    switchFailed: 'Workspace switch failed. Please try again later.',
    switcher: {
    ...
    subscriptionUsage: {
      ...
      description: 'View the current workspace plan, period, storage, and credit balance',
      loading: 'Loading subscription and usage...',
      personalAccount: 'Personal Account',
      personalEdition: 'Personal',
      personalDescription: 'Storage usage and currently available credits in your personal workspace',
      personalCreditSource: 'Personal balance',
      enterpriseAccount: 'Organization Account',
      enterpriseEdition: 'Organization allocated',
      enterpriseDescription: 'Allocated by "{name}" and calculated separately from your personal account',
      enterpriseCreditSource: 'Organization balance',
      ...
      creditAvailable: 'Currently available',
      periodCredits: 'Period credits',
      periodCreditsDescription: 'Credits included in the subscription period',
      periodCreditsUsed: '{count} used this period',
      periodCreditsRemaining: '{count} remaining',
      points: '{count} credits',
      unlimited: 'Unlimited',
      memberUsageTitle: 'Member usage ranking',
      memberUsageDescription: 'Current-period usage, effective limits, and overage policy by member',
      member: 'Member',
      memberUsage: 'Period usage',
      myMonthlyUsage: 'My monthly usage',
      memberStrategy: 'Member strategy',
      memberOverage: 'Overage policy',
      memberLastBilling: 'Last billed',
      memberLimit: 'Limit {limit} credits',
      noMemberUsage: 'No member usage',
      memberUsageLoadFailed: 'Failed to load member usage',
      strategy: {
        inherit: 'Enterprise default',
        custom: 'Custom limit',
        unlimited: 'No member limit',
      },
      personalLoadFailed: 'Failed to load personal account usage',
      enterpriseLoadFailed: 'Failed to load organization allocation',
      recentUsage: 'Recent model usage',
      recentUsageDescription: 'The latest 20 model billing records for this workspace',
      model: 'Model',
      tokens: 'Tokens',
      inputOutputTokens: 'Input / output',
      billedCredits: 'Billed credits',
      usageStatus: 'Status',
      billingTime: 'Billing time',
      noRecentUsage: 'No model usage records',
      enterprisePolicyTitle: 'Enterprise usage policy',
      enterprisePolicyDescription: 'Set the default monthly member limit and what happens after included credits are exhausted',
      defaultMemberMonthlyLimit: 'Default member monthly limit',
      defaultMemberMonthlyLimitDescription: 'Members using the enterprise default can consume this many included credits per billing period',
      overagePolicy: 'Overage policy',
      overagePolicyDescription: 'Controls calls after a member reaches the monthly limit or the enterprise period pool is exhausted',
      overageBlock: 'Block calls',
      overageUseBalance: 'Use enterprise balance',
      savePolicy: 'Save policy',
      policySaved: 'Enterprise usage policy updated',
      policyLoadFailed: 'Failed to load enterprise usage policy',
      policySaveFailed: 'Failed to save enterprise usage policy',
      enterprisePermissionRequired: 'Enterprise admin or owner access is required',
      creditUnit: 'credits / month',
    },
    ...
    enterprise: {
      edition: 'Enterprise',
      openAction: 'Enable Enterprise',
      dialogTitle: 'Enable Enterprise',
      dialogSubtitle: 'A new enterprise workspace will be created while your personal workspace stays unchanged. Personal knowledge bases are not moved or overwritten.',
      nameLabel: 'Enterprise workspace name',
      namePlaceholder: 'e.g. Northstar Education',
      nameRequired: 'Enter an enterprise workspace name',
      descriptionLabel: 'Enterprise workspace description (optional)',
      descriptionPlaceholder: 'Describe the team or business purpose of this workspace',
      submit: 'Create enterprise workspace',
      cancel: 'Cancel',
      success: 'Enterprise workspace created. Switching now',
      createdButSwitchFailed: 'Enterprise workspace created. Open it from the workspace switcher.',
      failed: 'Failed to create enterprise workspace',
    },
    details: {
    ...
    globalSettings: {
      ...
      keyDescriptions: {
        auth: {
          ...
          default_tenant_mode:
            'Workspace provisioning after public registration. create_personal creates a personal Owner workspace; tenantless is a legacy compatibility value and user-facing account creation still creates a personal workspace.',
        },
        ssrf: {
          whitelist:
      ...
      enumLabels: {
        auth: {
          ...
          default_tenant_mode: {
            ...
            tenantless: 'Legacy compatibility (still creates a personal workspace)',
          },
        },
      },
      confirm: {
  ...
  model: {
    ...
    editor: {
      ...
      modelNamePlaceholder: {
        ...
        remoteOcr: 'e.g. qwen3.5-ocr, qwen-vl-ocr, gpt-4o-mini',
      ...
      baseUrlPlaceholderAliyunOcr: 'e.g. https://your-workspace-id.cn-beijing.maas.aliyuncs.com/compatible-mode/v1',
      baseUrlDescAliyunOcr: 'Alibaba Qwen OCR requires a Model Studio workspace Base URL. Do not use the generic dashscope.aliyuncs.com URL, and do not append /chat/completions.',
      aliyunOcrGenericBaseUrlError: 'Alibaba Qwen OCR cannot use the generic dashscope.aliyuncs.com URL. Enter the Model Studio workspace Base URL, for example https://your-workspace-id.cn-beijing.maas.aliyuncs.com/compatible-mode/v1, without /chat/completions.',
  ...
  modelSettings: {
    ...
    description: 'Manage AI model configuration, provider credentials, testing, and model pricing',
    typeShort: {
      chat: 'Chat',
      embedding: 'Embedding',
      rerank: 'ReRank',
  ...
  organization: {
    ...
    rbac: {
      ...
      enterpriseOnly: 'Team spaces are only available in Enterprise workspaces.',
      cannotCreate: 'Your workspace role is insufficient to create a team space',
      cannotJoin: 'Your workspace role is insufficient to manage team-space participation',
      cannotManage: 'Your workspace role is insufficient to manage this team space',
    },
    invite: {
      knowledgeBases: 'Knowledge Bases',
      agents: 'Agents',
    ...
    empty: 'You have not created any team space yet',
    emptyDesc: 'Create a team space to become its owner and invite members',
    all: 'All',
    createdByMe: 'Created by me',
    joinedByMe: 'Joined',
    createdTag: 'Created',
    ...
    settings: {
      ...
      membersDesc: 'View and manage participating members and their roles. Only added members can access this team space.',
      sharedDesc: 'View all knowledge bases shared to this space',
      noSharedKB: 'No shared knowledge bases yet',
      noSharedKBTip: 'Click "Add knowledge base" to select and share a knowledge base from the current enterprise workspace',
      addKnowledgeBase: 'Add knowledge base',
      addKnowledgeBaseDialogTitle: 'Add enterprise knowledge bases',
      addKnowledgeBaseDialogDesc: 'Select knowledge bases from the current enterprise workspace to share with this team space',
      addKnowledgeBaseSearchPlaceholder: 'Search by knowledge base name or description',
      addKnowledgeBaseEmpty: 'No knowledge bases are available in the current enterprise workspace',
      addKnowledgeBaseSelected: '{count} knowledge bases selected',
      addKnowledgeBaseConfirm: 'Add and share',
      addKnowledgeBaseSuccess: '{count} knowledge bases added',
      addKnowledgeBasePartialSuccess: '{success} knowledge bases added, {failed} failed',
      addKnowledgeBaseFailed: 'Failed to add knowledge bases. Please try again',
      addKnowledgeBaseLoadFailed: 'Failed to load enterprise knowledge bases. Please try again',
      addAgent: 'Add agent',
      addAgentDialogTitle: 'Add enterprise agents',
      addAgentDialogDesc: 'Select agents from the current enterprise workspace to share with this team space',
      addAgentSearchPlaceholder: 'Search by agent name or description',
      addAgentEmpty: 'No agents are available in the current enterprise workspace',
      addAgentSelected: '{count} agents selected',
      addAgentConfirm: 'Add and share',
      addAgentSuccess: '{count} agents added',
      addAgentPartialSuccess: '{success} agents added, {failed} failed',
      addAgentFailed: 'Failed to add agents. Please try again',
      addAgentLoadFailed: 'Failed to load enterprise agents. Please try again',
      ...
      noSharedAgentsTip: 'Click "Add agent" to select and share an agent from the current enterprise workspace',
    ...
    addMember: {
      ...
      tip: 'Choose a user account from user management data. Only the selected account receives access.',
      tipTenant: 'Choose a user account from user management data. Only the selected account receives access.',
      searchUser: 'Select Member',
      searchTenant: 'Select Workspace',
      searchPlaceholder: 'Search by member name or phone...',
      searchTenantPlaceholder: 'Search by workspace name, username or phone...',
      searchHint: 'Defaults to active accounts from user management. Type at least 2 characters to search by name or phone.',
      ...
      alreadyInSpace: 'Member already joined',
  ...
  commandPalette: {
    ...
    quick: {
      ...
      agents: 'Open agents',
      organizations: 'Open team spaces',
  ...
  kbSettings: {
    vectorStore: {
      ...
      engineDesc:
        'Pick a store from the global Vector Stores configuration, or leave as System default to use the workspace-wide RETRIEVE_DRIVER engine.',
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: '睿乐大脑云',
          desc: 'Document parsing via 睿乐大脑云',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  agentEditor: {
    ...
    agentType: {
      ...
      kbMismatch: {
        ...
        educationSales: 'Requires RAG retrieval',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: 'Let this key manage the full knowledge-base lifecycle: create, copy, update, and delete knowledge bases and change their initialization/configuration. Operations on existing knowledge bases (copy/update/delete) stay bounded by the selected scope; creating a new knowledge base is unrestricted (the new KB belongs to this space).',
	      ...
	      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and 睿乐大脑云 credentials.',
	      ...
	      capabilityManageMembers: 'Manage users',
	      capabilityManageMembersHint: 'List and manage workspace users and roles. Does not include API key management, workspace deletion, or ownership transfer.',
	      capabilityManageSpaces: 'Manage spaces',
	      capabilityManageSpacesHint: 'Manage Team Spaces, membership, and published-resource visibility. Does not grant KB or agent share management.',
	      capabilityManageTenantSettings: 'Manage workspace settings',
	      capabilityManageTenantSettingsHint: 'Read and update workspace-level integration settings such as API end-user identity mode, request header configuration, and workspace KV settings. Does not include API key management, user management, workspace deletion, or ownership transfer.',
      ...
      signedFlowDetail:
        'Keep the HMAC secret only on 睿乐大脑 and your trusted backend—never put it in requests or ship it to browsers. The request header carries the JWT string signed with that secret (it changes on each issuance or after expiry), not the secret itself. JWT must include sub (external user ID), tenant_id, aud=weknora, and exp (max 24h lifetime).',
      directHeader: 'User ID header',
      requireDirectHeader: 'Require user ID header',
      requireDirectHeaderDesc:
        'When enabled, API Key requests without the user ID header are rejected; when disabled, all requests are treated as the whole workspace with no per-user distinction.',
      tokenHeader: 'Token header',
      tokenHeaderDesc: 'Clients send the backend-signed JWT in this fixed header.',
      hmacSecret: 'HMAC secret',
      hmacSecretDesc: 'Same secret stored in 睿乐大脑; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    claw: {
      title: '睿乐大脑 Skill',
      subtitle:
        'Import documents and run hybrid retrieval (vector + keyword) via the 睿乐大脑 REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      steps: {
        ...
        install: {
          ...
          desc: 'Run the command below in an environment with the OpenClaw CLI installed.',
        },
        verify: {
      ...
      ecosystemNote: 'Install from your approved internal distribution source.',
      installCta: 'Install Skill',
      installCtaHint: 'Install 睿乐大脑 Skill · opens in a new tab',
      hubMeta: 'Internal distribution',
    },
  },
  imOverview: {
  ...
  tenantMember: {
    ...
    sectionDescription:
      'Maintain all members in the current enterprise workspace and assign roles. Owners and Admins can manage ordinary members; Owner-role changes are limited to Owners or system admins.',
    learnRbacGuide: 'Learn about RBAC',
    totalCount: '{n} members',
    listTitle: 'All enterprise members',
    filterMatched: '{n} matched',
    loading: 'Loading members…',
    retry: 'Retry',
    empty: 'No members in this enterprise workspace yet. Add a member to get started.',
    emptySearch: 'No members match "{q}".',
    emptyFiltered: 'No members match the current filters.',
    searchPlaceholder: 'Search by name, email, or external ID',
    permissions: {
    ...
    columns: {
      ...
      workProfile: 'Avatar description',
      allocation: 'Credit policy',
      joinedAt: 'Joined',
      operations: 'Actions',
    },
    filters: {
    ...
    create: {
      ...
      phoneLabel: 'Phone',
      phonePlaceholder: 'Enter phone number',
      passwordHint: 'Default password is rl + last 6 digits:',
      submit: 'Create',
      success: 'User added. Default password: {password}',
      existingAccountSuccess: 'Existing account added to this workspace',
    },
    allocation: {
      button: 'Edit credit policy',
      dialogTitle: 'Set credit policy for {name}',
      limitMode: 'Member monthly limit',
      monthlyLimit: 'Custom monthly credit limit',
      inherit: 'Use enterprise default',
      custom: 'Custom',
      unlimited: 'Unlimited',
      inheritDescription: 'Currently uses the enterprise default of {count} credits per month.',
      customDescription: 'Set an independent monthly credit limit for this member.',
      unlimitedDescription: 'No member-level monthly cap. Enterprise credits and the overage policy still apply.',
      mode: {
        inherit: 'Enterprise default',
        custom: 'Custom limit',
        unlimited: 'Unlimited',
      },
      usedOfLimit: '{used} / {limit} credits used this month',
      usedUnlimited: '{used} credits used this month / unlimited',
      periodPoints: 'Period credits',
      balancePoints: 'Balance credits',
      used: 'Used',
      unassigned: 'Unassigned',
      period: 'Current period: {start} to {end}',
      save: 'Save policy',
      success: 'Member credit policy updated',
      loadError: 'Failed to load member credit policies',
      saveError: 'Failed to save member credit policy',
      batchButton: 'Set credit policies in batch',
      batchDialogTitle: 'Set credit policy for {count} members',
      batchDescription: 'Saving replaces the current-period credit policy for every selected member.',
      batchSave: 'Apply to selected members',
      batchSuccess: 'Updated credit policies for {count} members',
      batchSaveError: 'Failed to save member credit policies',
    },
    assetTransfer: {
      button: 'Transfer assets',
      dialogTitle: 'Transfer enterprise assets from {name}',
      loading: 'Loading transferable assets…',
      description: 'This member is responsible for {knowledgeBases} knowledge bases and {agents} agents. Only responsibility changes; enterprise data stays in place.',
      empty: 'This member has no enterprise knowledge bases or agents to transfer.',
      targetType: 'Transfer target',
      targetEnterprise: 'Enterprise owned',
      targetMember: 'Another member',
      targetMemberLabel: 'Receiving member',
      targetMemberPlaceholder: 'Select an active member in this enterprise',
      assetsLabel: 'Assets',
      knowledgeBases: 'Knowledge bases ({count})',
      agents: 'Agents ({count})',
      reasonLabel: 'Reason',
      reasonPlaceholder: 'For example: employee offboarding or role change',
      preserveHint: 'Documents, files, chunks, FAQ, wiki pages, vector indexes, and shares remain in this enterprise. Personal chats, memories, and credentials are not transferred.',
      confirm: 'Transfer assets',
      success: '{count} enterprise assets transferred',
      loadError: 'Failed to load transferable assets',
      saveError: 'Failed to transfer assets',
      removeBlocked: 'This member still owns enterprise assets. Transfer them first.',
    },
    remove: {
      button: 'Remove',
      confirmTitle: 'Remove user?',
      confirmBody: 'Are you sure you want to remove {name} from this workspace users list? They will lose access immediately.',
      confirm: 'Remove',
      success: 'User removed',
    },
    suspend: {
      button: 'Suspend',
      confirmBody: 'Suspend {name}? They will immediately lose access to this workspace and active sessions will be revoked.',
      confirm: 'Suspend',
      success: 'User suspended',
    },
    reactivate: {
      button: 'Reactivate',
      confirmBody: 'Reactivate {name} for this workspace?',
      confirm: 'Reactivate',
    ...
    workProfile: {
      ...
      shortButton: 'Set avatar',
      edit: 'Edit avatar description',
      dialogTitle: 'Edit avatar description',
      jobLabel: 'Job title',
      jobPlaceholder: 'Enter a job title, such as principal or admissions consultant',
      label: 'Avatar description',
      placeholder:
        'Describe who this employee serves, what they handle, what they do not handle, service boundaries, and readable memory scope.',
      hint: 'Service routing extracts role, service subjects, responsibilities, and boundaries from this description.',
      empty: 'Not set',
      suggest: 'AI autofill',
      suggestSuccess: 'Avatar description generated',
      suggestFailed: 'Failed to generate avatar description',
      jobRequired: 'Enter a job title',
      save: 'Save description',
      success: 'Avatar description saved',
    },
    errors: {
      nameRequired: 'Name is required',
      ...
      nameExists: 'An account with this name already exists. Use a distinguishable name.',
      roleRequired: 'Role is required',
      workProfileRequired: 'Avatar description is required',
      userNotFound: 'No registered user with this phone number. Ask them to sign up first.',
      alreadyMember: 'This user is already in the workspace.',
      enterpriseMembershipExists: 'This user already belongs to another enterprise workspace and cannot join another one.',
      ...
      ownerRequiresOwner: 'Owner-role operations require an Owner or system admin.',
    ...
    audit: {
      tabLabel: 'Audit log',
      description:
        'Records every user change and access denial in this workspace. Newest first. Repeated denials within a minute are deduplicated.',
      refresh: 'Refresh',
      loadMore: 'Load older',
      end: 'End of log.',
      ...
      action: {
        'rbac.member_added': 'User added',
        'rbac.member_removed': 'User removed',
        'rbac.member_role_changed': 'Role changed',
        'rbac.member_profile_changed': 'Avatar description changed',
        'rbac.member_suspended': 'User suspended',
        'rbac.member_reactivated': 'User reactivated',
        'rbac.member_assets_transferred': 'Member assets transferred',
        'rbac.member_left': 'User left',
        ...
        'billing.member_allocation_changed': 'Member allocation changed',
        'billing.member_usage_policy_changed': 'Member credit policy changed',
        'billing.enterprise_policy_changed': 'Enterprise usage policy changed',
      },
      assetTransferDiff: '{count} assets transferred to {target}',
      outcome: {
        success: 'Success',
        denied: 'Denied',
      },
  ...
  tenantInvitation: {
    ...
    confirmInviteBody:
      'Send an invitation to phone number {phone} (role: {role}). They will join the workspace only after accepting.',
    confirmSend: 'Send',
    ...
    shareLink: {
      ...
      description:
        "Generate a multi-use registration link you can drop in a group chat. Share links can grant only Contributor or Viewer. Expires in {days} days, or revoke it any time from the list.",
      generate: 'Generate link',
      resultTitle: 'Invitation link ready',
      roleRestricted: 'Share invitation links can grant only Contributor or Viewer.',
    ...
    myInbox: {
      ...
      description:
        'Invitations from other workspaces. Accept to join with the assigned role.',
