...
\
  ...
  integrations: {
    ...
    chrome: {
      ...
      subtitle:
        'For self-hosted 睿乐大脑: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On 睿乐大脑 Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.',
        },
        install: {
          title: 'Install the extension',
          desc: 'Install “Knowledge Assistant” from your approved internal distribution source.',
        },
        connect: {
      ...
      installCta: 'Install Extension',
      installCtaHint: 'Use your approved internal distribution source',
      storeMeta: 'Browser extension · v1.0.0',
    },
    claw: {
      title: '睿乐大脑 Skill',
      subtitle:
