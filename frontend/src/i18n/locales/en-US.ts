...
\
  ...
  organization: {
    ...
    rbac: {
      ...
      cannotJoin: 'Your workspace role is insufficient to manage shared-space participation',
    ...
    emptyJoinedDesc: 'Wait for a shared-space admin to add this member account',
    role: {
      admin: 'Admin',
      editor: 'Editor',
      viewer: 'Viewer',
    ...
    settings: {
      ...
      membersDesc: 'View and manage participating members and their roles. Only added members can access this shared space.',
  ...
  tenantMember: {
    ...
    sectionDescription:
      'Maintain all user accounts in the current workspace and assign roles. Owners and Admins can manage ordinary users; Owner-role changes are limited to Owners or system admins.',
    learnRbacGuide: 'Learn about RBAC',
    totalCount: '{n} users',
    listTitle: 'Workspace users',
    filterMatched: '{n} matched',
    loading: 'Loading users…',
    retry: 'Retry',
    empty: 'No users in this workspace yet. Add a user to get started.',
