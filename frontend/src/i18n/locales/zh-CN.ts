export default {
  ...
  integrations: {
    ...
    chrome: {
      title: "知识管理助手",
      subtitle:
        "配合睿乐大脑自建服务使用：在任意网页侧边栏提问、剪藏内容、Markdown 速记，将浏览中的知识沉淀到你的知识库。",
      ...
      steps: {
        ...
        port: {
          title: "桌面版配置固定端口（推荐）",
          desc: "使用睿乐大脑桌面版时，在 API 信息中设置固定端口（如 37841），避免每次启动后地址变化导致插件断连。",
        },
        install: {
          title: "安装 Chrome 插件",
          desc: "从已批准的内部分发源安装「知识管理助手」。",
        },
        connect: {
          title: "在插件中完成连接",
      ...
      installCta: "安装插件",
      installCtaHint: "请使用已批准的内部分发源",
      storeMeta: "浏览器插件 · v1.0.0",
    },
    claw: {
      title: "睿乐大脑 Skill",
      subtitle:
