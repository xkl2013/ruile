export default {
  ...
  agent: {
    ...
    empty: {
      ...
      sharedTitle: "暂无共享智能体",
      sharedDescription: "共享空间管理员添加当前空间后，或他人直接共享智能体后，会显示在这里",
      favoritesTitle: "暂无收藏",
    ...
    shareScope: {
      title: "共享范围说明",
      desc: "参与空间以只读方式使用该智能体，将遵循您当前配置的能力与资源；您对智能体的修改会同步给已共享的共享空间。如需允许参与空间编辑知识库内容，请将知识库共享到共享空间。",
      knowledgeBase: "知识库",
      chatModel: "对话模型",
      rerankModel: "重排模型",
      webSearch: "网络搜索",
  ...
  knowledgeList: {
    ...
    emptyShared: "暂无协作知识库，参与共享空间后可获取他人共享的知识库",
    empty: {
      title: "暂无知识库",
      description: '点击左侧快捷操作"新建知识库"按钮创建第一个知识库',
      sharedTitle: "暂无共享知识库",
      sharedDescription: "共享空间管理员添加当前空间后，或他人直接共享知识库后，会显示在这里",
      favoritesTitle: "暂无收藏",
  ...
  knowledgeEditor: {
    ...
    share: {
      description: "将知识库共享给共享空间，让参与空间可以访问和使用",
      addShare: "共享",
  ...
  organization: {
    title: "共享空间",
    subtitle: "创建共享空间，并由管理员添加参与成员，共享知识库与智能体",
    createOrg: "创建共享空间",
    createOrgShort: "新建",
    name: "共享空间名称",
    ...
    rbac: {
      ...
      cannotJoin: "当前空间角色不足，无法管理共享空间参与关系",
    ...
    leave: "退出共享空间",
    leaveConfirm: "确定要退出该共享空间吗？",
    leaveConfirmTitle: "退出共享空间",
    leaveConfirmMessage: "确定要退出共享空间「{name}」吗？退出后当前空间将无法访问其中共享的知识库。",
    leaveSuccess: "已退出共享空间",
    leaveFailed: "退出共享空间失败",
    deleteConfirm: "确定要删除该共享空间吗？此操作不可撤销。",
    deleteConfirmTitle: "删除共享空间",
    deleteConfirmMessage: "确定要删除共享空间「{name}」吗？删除后所有参与成员将被移除，此操作不可撤销。",
    ...
    empty: "您还没有加入任何共享空间",
    emptyDesc: "创建一个共享空间后，可在参与成员中由管理员添加用户账号",
    all: "全部",
    createdByMe: "我创建的",
    joinedByMe: "我加入的",
    createdTag: "创建",
    ...
    emptyJoinedDesc: "等待共享空间管理员添加当前空间",
    role: {
      admin: "管理员",
      editor: "编辑",
      viewer: "只读",
    ...
    detail: {
      ...
      removeMember: "移除参与成员",
      shareKBTip: "在知识库列表中选择知识库，点击共享按钮将其共享到指定共享空间",
    },
    settings: {
      editTitle: "共享空间设置",
      detailTitle: "共享空间详情",
      myRoleDesc: "当前成员在此共享空间中的角色决定了权限范围",
      membersDesc: "查看哪些成员已加入本共享空间，并调整这些成员的共享权限。只有被添加的成员可以访问本共享空间内容。",
      sharedDesc: "查看共享到本共享空间的所有知识库",
      noSharedKB: "暂无共享的知识库",
      noSharedKBTip: "知识库拥有者可以在知识库设置中将其共享到本共享空间",
      sharedAgents: "共享智能体",
      noSharedAgents: "暂无共享的智能体",
      sharedAgentsDesc: "已共享到本共享空间的智能体，参与成员可在对话中使用",
      sharedAgentsKbHint: "智能体绑定的知识库仅在参与成员使用该智能体对话时可 {'@'} 使用（只读），不会出现在「知识库列表」中。若需参与成员在列表中看到或编辑知识库，请单独将知识库共享到本空间。",
      ...
      permissionCalcFormula: "共享权限为共享时给参与成员设定的权限；我的实际权限 = min(共享权限, 当前成员在本共享空间中的角色)",
      permissionCalcTip: "我的实际权限 = min(共享权限, 当前成员在本共享空间中的角色)。当前成员在共享空间内是只读时，对此知识库最多只读；是编辑或管理员时，不超过共享权限。",
      removeShareFromOrg: "从共享空间中移除",
      removeShareConfirm: "确定将「{name}」从本共享空间中移除？移除后参与成员将无法再访问该知识库。",
      removeAgentShareConfirm: "确定将「{name}」从本共享空间中移除？移除后参与成员将无法再访问该智能体。",
    ...
    editor: {
      ...
      navPermissions: "权限说明",
      basicTitle: "基本信息",
      basicDesc: "设置共享空间的名称和描述，便于参与成员识别",
      nameTip: "建议使用集团、区域或协作项目名称，便于参与成员识别",
      descriptionTip: "描述共享空间的用途和目标，帮助参与成员了解边界",
      ...
      editAccess: "编辑权限",
      viewAccess: "只读权限",
      adminPerm1: "管理共享空间设置、参与成员及知识库与智能体共享",
    ...
    share: {
      ...
      modelShareDesc: "将模型共享到共享空间，参与成员可使用该模型",
      agentShareDesc: "将智能体共享到共享空间，参与成员可使用该智能体",
      spaceAgentShareCountTip: "该共享空间的共享智能体数量",
      selectOrg: "选择共享空间",
      selectOrgPlaceholder: "请选择要共享到的共享空间",
      permission: "权限",
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: "允许管理知识库全生命周期：新建、复制、修改、删除知识库并调整初始化/配置信息。针对已有知识库的操作（复制/更新/删除）仍受所选知识库范围限制；新建不受限（新知识库归本空间）。",
	      ...
	      capabilityManageSpacesHint: "允许管理共享空间、加入流程、参与空间、邀请和共享空间可见性；不授予知识库或智能体分享管理权限。",
  ...
  tenantMember: {
    title: "用户管理",
    sectionDescription:
      "维护当前空间中的所有用户账号并分配角色。Owner 和 Admin 可管理普通用户；Owner 角色变更仅限 Owner 或系统管理员。",
    ...
    loading: "正在加载用户…",
    retry: "重试",
    empty: "当前空间暂无用户。点击右上角添加用户。",
    emptySearch: '没有匹配 "{q}" 的用户。',
