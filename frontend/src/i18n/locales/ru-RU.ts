...
/example\.(net|org)/`,
  ...
  integrations: {
    ...
    chrome: {
      ...
      subtitle:
        'Для self-hosted 睿乐大脑: вопросы в боковой панели, клиппинг страниц и Markdown-заметки в базы знаний прямо при просмотре.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'В 睿乐大脑 Desktop задайте фиксированный порт API (например 37841) в API-информации.',
        },
        install: {
          title: 'Установите расширение',
          desc: 'Установите «Помощник по знаниям» из утверждённого внутреннего источника.',
        },
        connect: {
      ...
      installCta: 'Установить расширение',
      installCtaHint: 'Используйте утверждённый внутренний источник',
      storeMeta: 'Расширение браузера · v1.0.0',
    },
    claw: {
      title: '睿乐大脑 Skill',
      subtitle:
