export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и 睿乐大脑 автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
  ...
  knowledgeBase: {
    ...
    rename: 'Изменить название базы знаний',
    ...
    directory: 'Каталог',
    allDocuments: 'Все файлы',
    rootDirectory: 'Корень',
    ...
    editDirectoryTitle: 'Изменить каталог',
    parentDirectory: 'Родительский каталог',
    directoryName: 'Название каталога',
    directoryNamePlaceholder: 'Введите название каталога',
    directoryDescription: 'Описание каталога',
    directoryDescriptionPlaceholder: 'Введите описание каталога',
    directoryNameRequired: 'Введите название каталога',
    directoryNameInvalid: 'Название каталога не может содержать / или \\',
    directoryDuplicate: 'Каталог уже существует',
    directoryCreateSuccess: 'Каталог добавлен',
    directorySaveSuccess: 'Настройки каталога сохранены',
    columnName: 'Имя',
    columnTag: 'Тег',
    columnSize: 'Размер',
    columnType: 'Тип',
  ...
  settings: {
    ...
    workProfile: {
      ...
      description: 'Настройте описание рабочего профиля для текущего пространства, чтобы обозначить обязанности и границы сервиса.',
      fieldLabel: 'Описание рабочего профиля',
      fieldDescription: 'Кратко опишите обязанности, пользователей сервиса и рабочие границы.',
      placeholder: 'Например: отвечает за консультации по приёму, общение с родителями и сопровождение курсов, а также помогает организовывать образовательные знания.',
      empty: 'Описание рабочего профиля ещё не задано',
      edit: 'Изменить',
      save: 'Сохранить',
      cancel: 'Отмена',
      saved: 'Описание рабочего профиля сохранено',
      loadFailed: 'Не удалось загрузить описание рабочего профиля',
      saveFailed: 'Не удалось сохранить описание рабочего профиля',
      required: 'Введите описание рабочего профиля',
      noWorkspace: 'Нет рабочего пространства для редактирования',
      promptLabel: 'Генерация профиля с ИИ',
      promptDescription: 'Опишите должность, пользователей сервиса, задачи или другие требования. ИИ подготовит редактируемое описание.',
      promptPlaceholder: 'Например: я консультант по приёму в детском саду, отвечаю за вопросы родителей, пробные занятия и сопровождение записи.',
      generate: 'Создать с ИИ',
      generating: 'Создание...',
      promptRequired: 'Сначала введите запрос',
      generateFailed: 'Не удалось создать рабочий профиль с ИИ',
      generated: 'Черновик создан. Проверьте его и сохраните.',
    },
    navGroups: {
      account: 'Аккаунт',
    ...
    teamSpace: {
      ...
      enterpriseUsage: 'Использование организации',
    ...
    weknoraCloud: {
      title: '睿乐大脑云',
      description: 'Настройте учётные данные APPID и APPSECRET для 睿乐大脑云. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные 睿乐大脑云 истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения 睿乐大脑云',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения 睿乐大脑云',
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в 睿乐大脑',
  ...
  auth: {
    ...
    registerSubtitle: 'Создайте аккаунт и начните работу с 睿乐大脑',
    ...
    loginError: 'Ошибка входа, пожалуйста, проверьте телефон или пароль',
  ...
  tenant: {
    ...
    subscriptionUsage: {
      title: 'Подписка и использование',
      description: 'Просмотр личных ресурсов и отдельных ресурсов, выделенных организацией',
      loading: 'Загрузка подписки и использования...',
      personalAccount: 'Личная учётная запись',
      personalEdition: 'Личный тариф',
      personalDescription: 'Использование хранилища и доступные баллы в личном пространстве',
      personalCreditSource: 'Личный баланс',
      enterpriseAccount: 'Учётная запись организации',
      enterpriseEdition: 'Выделено организацией',
      enterpriseDescription: 'Выделено пространством «{name}» и рассчитывается отдельно от личной квоты',
      enterpriseCreditSource: 'Баланс организации',
      resourceUsage: 'Использование ресурсов',
      storageUsage: 'Использование хранилища',
      usedOfTotal: '{used} / {total}',
      remaining: 'Осталось {amount}',
      creditBalance: 'Баланс баллов',
      creditAvailable: 'Доступно сейчас',
      points: '{count} баллов',
      unlimited: 'Без ограничений',
      memberUsageTitle: 'Рейтинг использования участниками',
      memberUsageDescription: 'Фактическое использование, лимиты и политика превышения за текущий период',
      member: 'Участник',
      memberUsage: 'Использование за период',
      memberStrategy: 'Политика участника',
      memberOverage: 'Политика превышения',
      memberLastBilling: 'Последнее списание',
      memberLimit: 'Лимит {limit} баллов',
      noMemberUsage: 'Данных об использовании участниками пока нет',
      memberUsageLoadFailed: 'Не удалось загрузить использование участниками',
      strategy: {
        inherit: 'Настройки организации',
        custom: 'Собственный лимит',
        unlimited: 'Без лимита участника',
      },
      personalLoadFailed: 'Не удалось загрузить использование личной учётной записи',
      enterpriseLoadFailed: 'Не удалось загрузить ресурсы организации',
      recentUsage: 'Недавнее использование моделей',
      recentUsageDescription: 'Последние 20 записей биллинга моделей для этого пространства',
      model: 'Модель',
      tokens: 'Токены',
      inputOutputTokens: 'Ввод / вывод',
      billedCredits: 'Списанные баллы',
      usageStatus: 'Статус',
      billingTime: 'Время расчёта',
      noRecentUsage: 'Записей использования моделей пока нет',
      enterprisePolicyTitle: 'Политика использования организации',
      enterprisePolicyDescription: 'Настройка месячных лимитов участников и действий при превышении квоты',
      defaultMemberMonthlyLimit: 'Месячный лимит участника по умолчанию',
      defaultMemberMonthlyLimitDescription: 'Лимит баллов за расчётный период для участников с настройками организации',
      overagePolicy: 'Политика превышения',
      overagePolicyDescription: 'Действие после достижения месячного лимита или исчерпания баллов тарифа организации',
      overageBlock: 'Запретить вызовы',
      overageUseBalance: 'Использовать баланс организации',
      savePolicy: 'Сохранить политику',
      policySaved: 'Политика использования организации обновлена',
      policyLoadFailed: 'Не удалось загрузить политику использования организации',
      policySaveFailed: 'Не удалось сохранить политику использования организации',
      enterprisePermissionRequired: 'Требуются права администратора или владельца организации',
      creditUnit: 'баллов / месяц',
    },
    ...
    storage: {
      ...
      usedDescription: 'Объём хранилища, уже использованный текущим пространством',
      remainingLabel: 'Остаток хранилища',
      remainingDescription: 'Объём, доступный в рамках текущей квоты',
      usageLabel: 'Использование хранения',
      usageDescription: 'Процент использованного пространства',
      unlimited: 'Без ограничений',
      usedOfUnlimited: 'Использовано {used}',
      statusOk: 'Норма',
      statusWarning: 'Близко к лимиту',
      statusExceeded: 'Квота превышена',
      statusUnlimited: 'Без ограничений',
      warningHint: 'Использование этого пространства достигло порога {threshold}. Обратитесь к администратору, чтобы оценить необходимость увеличения квоты.',
      exceededHint: 'Это пространство превысило квоту хранения. Обратитесь к администратору для увеличения квоты перед дальнейшими загрузками или импортом.'
    },
    leaveDangerZone: {
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          noError: "Подробности ошибки не записаны",
          ...
          taskID: "Бизнес-задача {id}",
          retryOnce: "Запустить один раз",
          retryConfirm: "Убедитесь, что причина устранена. Задача будет немедленно запущена один раз.",
          retrySuccess: "Задача возвращена в очередь",
          retryError: "Не удалось запустить задачу",
          ...
          deleteSuccess: "Запись о сбое удалена",
        ...
        models: {
          ...
          columns: { model: "ID модели", active: "В работе", waiting: "Ожидание ограничения", usage: "Параллелизм" },
          status: { queued: "Ограничение", full: "На лимите" },
        },
        pools: {
      ...
      keyDescriptions: {
        auth: {
          registration_mode:
            'Режим самостоятельной регистрации. self_serve = любой может создать аккаунт; invite_only = открытая регистрация отключена, приглашать могут только Owner/Admin. Вступает в силу сразу после сохранения; используйте self_serve осторожно (в публичном интернете появятся спам-регистрации).',
          default_tenant_mode:
            'Политика пространства после открытой регистрации. create_personal создаёт личное пространство с ролью Owner; tenantless создаёт только аккаунт до принятия приглашения или самостоятельного создания пространства.',
        },
        ssrf: {
          whitelist:
            'Белый список SSRF-защиты. Можно указать example.com / *.foo.com / 10.0.0.0/8 / 2001:db8::1. Вступает в силу сразу после сохранения. Переменная окружения SSRF_WHITELIST_EXTRA по-прежнему задаётся при развёртывании и здесь не переопределяется.',
        },
        tenant: {
          max_owned_per_user:
            'Максимальное число пространств, которыми может владеть обычный (не супер) пользователь через самостоятельное создание. Читается при каждом создании пространства и вступает в силу сразу после сохранения. 0 — встроенное значение по умолчанию 10; отрицательное значение полностью снимает ограничение (не рекомендуется для публичных развёртываний).',
          self_service_creation_enabled:
            'Разрешает обычным пользователям самостоятельно создавать пространства. Если отключено, они могут только присоединяться по приглашению; межпространственные суперпользователи не ограничены.',
          default_storage_quota_gb:
            'Квота хранилища по умолчанию (ГБ) для нового пространства: векторы, оригиналы, текст, индексы и т.д. Читается только при создании — изменения применяются только к новым пространствам и не перезаписывают существующие. 0 или отрицательное значение — встроенное значение по умолчанию 10 ГБ.',
          auto_create_api_key:
            'Автоматически создаёт API-ключ full_access и возвращает его открытый токен при создании пространства. Включайте только для старых интеграций; по умолчанию отключено.',
        },
        asynq: {
          ...
          wiki_concurrency:
            'Параллелизм выделенного пула Wiki на процесс, изолированного от остальных задач. Минимум 1; требуется перезапуск сервиса.',
        },
        model: {
          max_concurrency:
  ...
  createChat: {
    title: 'Привет, я 睿乐大脑 — ваши знания всегда под рукой',
  ...
  embedPublish: {
    ...
    originsLabel: 'Разрешённые домены (по одному в строке, минимум один)',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      icon: 'Иконка',
      iconUpload: 'Загрузить изображение',
      iconImageInvalid: 'Выберите файл изображения',
      iconImageTooLarge: 'Изображение должно быть не больше {size} МБ',
      iconImageProcessFailed: 'Не удалось обработать изображение',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: '睿乐大脑云',
          desc: 'Парсинг документов через 睿乐大脑云',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  organization: {
    ...
    empty: 'Вы еще не создали ни одного командного пространства',
    emptyDesc: 'Создайте командное пространство, чтобы стать его владельцем и приглашать участников',
    all: 'All',
    ...
    settings: {
      ...
      noSharedKBTip: 'Нажмите «Добавить базу знаний», чтобы выбрать и предоставить доступ к базе из текущего корпоративного пространства',
      addKnowledgeBase: 'Добавить базу знаний',
      addKnowledgeBaseDialogTitle: 'Добавить корпоративные базы знаний',
      addKnowledgeBaseDialogDesc: 'Выберите базы знаний из текущего корпоративного пространства, чтобы открыть к ним доступ участникам командного пространства',
      addKnowledgeBaseSearchPlaceholder: 'Поиск по названию или описанию базы знаний',
      addKnowledgeBaseEmpty: 'В текущем корпоративном пространстве нет доступных баз знаний',
      addKnowledgeBaseSelected: 'Выбрано баз знаний: {count}',
      addKnowledgeBaseConfirm: 'Добавить и открыть доступ',
      addKnowledgeBaseSuccess: 'Добавлено баз знаний: {count}',
      addKnowledgeBasePartialSuccess: 'Добавлено: {success}, не удалось добавить: {failed}',
      addKnowledgeBaseFailed: 'Не удалось добавить базы знаний. Повторите попытку',
      addKnowledgeBaseLoadFailed: 'Не удалось загрузить корпоративные базы знаний. Повторите попытку',
      addAgent: 'Добавить агента',
      addAgentDialogTitle: 'Добавить корпоративных агентов',
      addAgentDialogDesc: 'Выберите агентов из текущего корпоративного пространства, чтобы открыть к ним доступ участникам командного пространства',
      addAgentSearchPlaceholder: 'Поиск по названию или описанию агента',
      addAgentEmpty: 'В текущем корпоративном пространстве нет доступных агентов',
      addAgentSelected: 'Выбрано агентов: {count}',
      addAgentConfirm: 'Добавить и открыть доступ',
      addAgentSuccess: 'Добавлено агентов: {count}',
      addAgentPartialSuccess: 'Добавлено: {success}, не удалось добавить: {failed}',
      addAgentFailed: 'Не удалось добавить агентов. Повторите попытку',
      addAgentLoadFailed: 'Не удалось загрузить корпоративных агентов. Повторите попытку',
      ...
      noSharedAgentsTip: 'Нажмите «Добавить агента», чтобы выбрать и предоставить доступ к агенту из текущего корпоративного пространства',
    ...
    addMember: {
      ...
      dialogTitle: 'Add Workspace',
      tip: 'Choose a representative member from member management data. Access is granted through that member\'s workspace, so users in the same workspace share access.',
      ...
      searchTenantPlaceholder: 'Поиск по имени пространства, имени пользователя или телефону...',
      searchHint: 'Defaults to active members from member management. Type at least 2 characters to search by name or phone.',
      searchTenantHint: 'Введите не менее 2 символов; результаты сгруппированы по пространству и не включают уже добавленных.',
      alreadyInSpace: 'Workspace already joined',
  ...
  datasource: {
    ...
    field: {
      ...
      baseUrl: 'Base URL',
      apiToken: 'API Token',
      baseUrlHint: 'Оставьте пустым, чтобы использовать публичное облако Yuque https://www.yuque.com. Если вы используете Yuque Enterprise или приватное развёртывание, укажите корпоративный домен (например, https://your-company.yuque.com)',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: 'Позволяет управлять всем жизненным циклом баз знаний: создавать, копировать, обновлять и удалять базы знаний, а также менять их инициализацию/конфигурацию. Операции над существующими базами знаний (копирование/обновление/удаление) по-прежнему ограничены выбранной областью; создание новой базы знаний не ограничено (новая база знаний принадлежит этому пространству).',
	      ...
	      capabilityManageModelsHint: 'Управление конфигурациями моделей, учётными данными, проверками подключения и данными 睿乐大脑云.',
      ...
      principalModeDesc:
        'Настройка того, как API-запросы идентифицируют конечного пользователя. Эта идентичность разделяет сессии диалога и авторизацию MCP-инструментов по пользователям, не сужая доступ API key уровня admin пространства.',
      principalScope:
        'Идентификация конечного пользователя разделяет сессии диалога и авторизацию MCP-инструментов (OAuth) по пользователям. API key по-прежнему имеет доступ ко всем базам знаний пространства; область API-прав не делится по внешним пользователям.',
    ...
    claw: {
      title: '睿乐大脑 Skill',
      subtitle:
        'Импорт документов и гибридный поиск (вектор + ключевые слова) через REST API 睿乐大脑 — загрузки, URL, Markdown и поиск.',
      ...
      steps: {
        ...
        install: {
          ...
          desc: 'Выполните команду ниже в среде с OpenClaw CLI.',
        },
      ...
      ecosystemNote: 'Устанавливайте Skill из утверждённого внутреннего источника.',
      installCta: 'Установить Skill',
      installCtaHint: 'Установка 睿乐大脑 Skill · откроется в новой вкладке',
      hubMeta: 'Внутреннее распространение',
    },
  },
  imOverview: {
  ...
  tenantMember: {
    ...
    create: {
      ...
      phoneLabel: 'Номер телефона',
      phonePlaceholder: 'Введите номер телефона',
      passwordHint: 'Пароль по умолчанию: rl + последние 6 цифр:',
      submit: 'Добавить',
    ...
    workProfile: {
      configure: 'Настроить аватар',
      shortButton: 'Настроить',
      edit: 'Редактировать описание аватара',
      dialogTitle: 'Описание рабочего аватара',
      jobLabel: 'Должность',
      jobPlaceholder: 'Введите должность, например директор или консультант по приему',
      label: 'Описание аватара',
      placeholder:
        'Опишите, кого обслуживает сотрудник, за что отвечает, что не входит в обязанности, границы сервиса и доступную память.',
      hint: 'Маршрутизация сервиса извлекает роль, объекты обслуживания, обязанности и границы из этого описания.',
      empty: 'Не задано',
      suggest: 'AI автозаполнение',
      suggestSuccess: 'Описание аватара сгенерировано',
      suggestFailed: 'Не удалось сгенерировать описание аватара',
      jobRequired: 'Укажите должность',
      save: 'Сохранить описание',
      success: 'Описание аватара сохранено',
    },
    errors: {
      ...
      workProfileRequired: 'Укажите описание аватара',
      ...
      enterpriseMembershipExists: 'Пользователь уже состоит в другом корпоративном пространстве и не может вступить в еще одно.',
    ...
    audit: {
      tabLabel: 'Журнал аудита',
      description:
        'Регистрирует все изменения участников и отказы в доступе в этом пространстве, в обратном хронологическом порядке. Повторные отказы в течение минуты дедуплицируются.',
      refresh: 'Обновить',
      loadMore: 'Показать ещё',
      end: 'Конец журнала.',
      ...
      action: {
        ...
        'rbac.member_profile_changed': 'Описание аватара изменено',
