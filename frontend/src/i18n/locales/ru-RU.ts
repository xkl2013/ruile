...
/example\.(net|org)/`,
  ...
  organization: {
    ...
    addMember: {
      ...
      tip: 'Choose a user from the user list. Access is granted through that user\'s workspace, so users in the same workspace share access.',
      ...
      searchHint: 'Choose from the list or type at least 2 characters to search',
