export default {
  ...
  integrations: {
    ...
    chrome: {
      title: "지식 관리 어시스턴트",
      subtitle:
        "자체 호스팅 睿乐大脑와 함께: 사이드바에서 질문하고, 웹 페이지를 클리핑하며, Markdown 메모를 지식베이스에 저장하세요.",
      ...
      steps: {
        ...
        port: {
          title: "데스크톱: 고정 포트(권장)",
          desc: "睿乐大脑 데스크톱에서는 API 정보에서 고정 포트(예: 37841)를 설정하세요.",
        },
        install: {
          title: "Chrome 확장 설치",
          desc: "승인된 내부 배포 소스에서 「지식 관리 어시스턴트」를 설치하세요.",
        },
        connect: {
          title: "확장에서 연결",
      ...
      installCta: "확장 설치",
      installCtaHint: "승인된 내부 배포 소스를 사용하세요",
      storeMeta: "브라우저 확장 · v1.0.0",
    },
    claw: {
      title: "睿乐大脑 Skill",
      subtitle:
