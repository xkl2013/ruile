export default {
  ...
  chatHeader: {
    ...
    renameRequired: "대화 제목은 비워 둘 수 없습니다",
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: "睿乐大脑에 오신 것을 환영합니다",
        desc: "몇 단계만으로 지식 베이스, 대화, 에이전트의 핵심 사용법을 안내합니다. '다음'을 눌러 시작하세요.",
      },
      knowledge: {
        title: "지식 베이스 만들기",
        desc: "모든 것의 시작점입니다. 문서, 웹페이지, FAQ를 업로드하면 睿乐大脑가 자동으로 분석하고 색인합니다. 여기를 클릭해 지식 베이스로 이동하세요.",
      },
      chat: {
        title: "AI 대화 시작하기",
  ...
  resourceOrigin: {
    ...
    space: "스페이스",
    spaceTooltip: "팀 스페이스 「{space}」에서 가져옴",
    spaceTooltipWithTenant: "팀 스페이스 「{space}」 · 출처 {tenant}",
    shared: "외부 공유",
    sharedTooltip: "팀 스페이스를 통해 외부 워크스페이스에서 접근",
  },
  knowledgeBase: {
    title: "지식베이스",
    list: "지식베이스 목록",
    ...
    videosFilteredNoVLM: "{count}개의 동영상 파일을 건너뜀",
    ...
    uploadFile: "파일 업로드",
    uploadFileDesc: "PDF, Word, TXT, 이미지, 오디오, 동영상 등 지원",
    importURL: "웹페이지 가져오기",
    addDocument: "문서 추가",
    ...
    deleteDirectoryConfirm: "\"{path}\" 디렉터리 설정을 삭제할까요? 파일 자체는 삭제되지 않습니다.",
    deleteDirectoryConfirmWithChildren: "\"{path}\" 및 하위 디렉터리 설정 {count}개를 삭제할까요? 파일 자체는 삭제되지 않습니다.",
    createSubdirectoryTitle: "하위 디렉터리 추가",
    directorySettingsTitle: "디렉터리 설정",
    editDirectoryTitle: "디렉터리 편집",
    parentDirectory: "상위 디렉터리",
    directoryName: "디렉터리 이름",
    directoryNamePlaceholder: "디렉터리 이름을 입력하세요",
    directoryDescription: "디렉터리 설명",
    directoryDescriptionPlaceholder: "디렉터리 설명을 입력하세요",
    directoryNameRequired: "디렉터리 이름을 입력하세요",
    directoryNameInvalid: "디렉터리 이름에는 / 또는 \\를 포함할 수 없습니다",
    directoryDuplicate: "디렉터리가 이미 존재합니다",
    directoryCreateSuccess: "디렉터리가 추가되었습니다",
    directorySaveSuccess: "디렉터리 설정이 저장되었습니다",
    directoryDeleteSuccess: "디렉터리가 삭제되었습니다",
    fileSize: "파일 크기",
    uploadTime: "업로드 시간",
    status: "상태",
    actions: "작업",
  ...
  uploadConfirm: {
    ...
    asrModelRequired: "이 배치에 오디오 또는 동영상이 포함되어 있습니다. ASR을 활성화하고 음성 인식 모델을 선택하세요",
    asrRequiredForAudio: "꺼짐(이 배치에 오디오/동영상 포함)",
  ...
  settings: {
    ...
    workProfile: {
      title: "분신",
      description: "현재 워크스페이스에서 사용할 분신 설명을 설정하여 담당 업무와 서비스 범위를 명확히 합니다.",
      fieldLabel: "분신 설명",
      fieldDescription: "담당 업무, 서비스 대상 및 범위를 한 단락으로 설명하세요.",
      placeholder: "예: 입학 상담, 학부모 소통, 수업 후속 관리를 담당하고 교육 관련 지식 정리를 지원합니다.",
      empty: "분신 설명이 아직 없습니다",
      edit: "편집",
      save: "저장",
      cancel: "취소",
      saved: "분신 설명이 저장되었습니다",
      loadFailed: "분신 설명을 불러오지 못했습니다",
      saveFailed: "분신 설명을 저장하지 못했습니다",
      required: "분신 설명을 입력하세요",
      noWorkspace: "편집할 수 있는 워크스페이스가 없습니다",
      promptLabel: "AI 분신 생성",
      promptDescription: "직무, 서비스 대상, 주요 업무 또는 기타 요구사항을 입력하면 AI가 편집 가능한 분신 설명을 생성합니다.",
      promptPlaceholder: "예: 유치원 입학 상담사로 학부모 문의, 체험 수업 예약, 등록 후속 관리를 담당합니다.",
      generate: "AI로 분신 생성",
      generating: "생성 중...",
      promptRequired: "먼저 생성 프롬프트를 입력하세요",
      generateFailed: "AI 분신 생성에 실패했습니다",
      generated: "초안이 생성되었습니다. 확인한 후 저장하세요.",
    },
    navGroups: {
      account: "계정",
      workspace: "공간",
    ...
    teamSpace: {
      ...
      enterpriseUsage: "기업 사용량",
      spaceManagement: "공간 관리",
    },
    roleDenied: {
      title: "권한 없음",
  ...
  auth: {
    ...
    registerSubtitle: "계정을 만들고 睿乐大脑를 시작하세요",
    ...
    passwordMismatch: "두 비밀번호가 일치하지 않습니다",
    loginError: "로그인 오류, 휴대폰 번호 또는 비밀번호를 확인해주세요",
  ...
  agent: {
    ...
    empty: {
      ...
      sharedDescription:
        "팀 스페이스 관리자가 현재 워크스페이스를 추가하거나 다른 사람이 에이전트를 직접 공유하면 여기에 표시됩니다.",
    ...
    shareScope: {
      title: "공유 범위 설명",
      desc: "스페이스 구성원은 읽기 전용 모드로 에이전트를 사용하며 현재 구성된 기능과 리소스를 따릅니다. 에이전트에 대한 수정 사항은 팀 스페이스에 동기화됩니다. 스페이스 구성원이 지식베이스 콘텐츠를 편집할 수 있도록 허용하려면 지식베이스를 스페이스에 공유하세요.",
      knowledgeBase: "지식베이스",
      chatModel: "대화 모델",
    ...
    builtinInfo: {
      ...
      salesDirector: {
        name: "영업 총괄",
        description: "교육 및 트레이닝 업계의 현장 직원을 위해 영업 전략, 상담 스크립트, 이의 대응, 후속 계획을 제공합니다.",
      },
      deepResearcher: {
        name: "심층 연구원",
        description:
  ...
  tenant: {
    ...
    subscriptionUsage: {
      title: "구독 및 사용량",
      description: "개인 계정 리소스와 기업에서 별도로 할당한 리소스를 확인합니다",
      loading: "구독 및 사용량을 불러오는 중...",
      personalAccount: "개인 계정",
      personalEdition: "개인용",
      personalDescription: "개인 워크스페이스의 저장소 사용량과 현재 사용 가능한 크레딧",
      personalCreditSource: "개인 계정 잔액",
      enterpriseAccount: "기업 계정",
      enterpriseEdition: "기업 할당",
      enterpriseDescription: "기업 워크스페이스 \"{name}\"에서 할당되며 개인 계정 한도와 별도로 계산됩니다",
      enterpriseCreditSource: "기업 할당 잔액",
      resourceUsage: "리소스 사용량",
      storageUsage: "저장소 사용량",
      usedOfTotal: "{used} / {total}",
      remaining: "{amount} 남음",
      creditBalance: "크레딧 잔액",
      creditAvailable: "현재 사용 가능",
      points: "{count} 크레딧",
      unlimited: "무제한",
      memberUsageTitle: "멤버 사용량 순위",
      memberUsageDescription: "현재 결제 주기의 실제 사용량, 유효 한도 및 초과 정책",
      member: "멤버",
      memberUsage: "현재 주기 사용량",
      memberStrategy: "멤버 정책",
      memberOverage: "초과 정책",
      memberLastBilling: "최근 청구",
      memberLimit: "한도 {limit} 크레딧",
      noMemberUsage: "멤버 사용량이 없습니다",
      memberUsageLoadFailed: "멤버 사용량을 불러오지 못했습니다",
      strategy: {
        inherit: "기업 기본값 상속",
        custom: "사용자 지정 한도",
        unlimited: "멤버 한도 없음",
      },
      personalLoadFailed: "개인 계정 사용량을 불러오지 못했습니다",
      enterpriseLoadFailed: "기업 할당량을 불러오지 못했습니다",
      recentUsage: "최근 모델 사용량",
      recentUsageDescription: "현재 워크스페이스의 최근 모델 청구 기록 20개",
      model: "모델",
      tokens: "토큰",
      inputOutputTokens: "입력 / 출력",
      billedCredits: "청구 크레딧",
      usageStatus: "상태",
      billingTime: "청구 시간",
      noRecentUsage: "모델 사용 기록이 없습니다",
      enterprisePolicyTitle: "기업 사용량 정책",
      enterprisePolicyDescription: "멤버 월별 크레딧 한도와 초과 사용 처리 방식을 설정합니다",
      defaultMemberMonthlyLimit: "기본 멤버 월별 크레딧 한도",
      defaultMemberMonthlyLimitDescription: "기업 기본값을 상속하는 멤버에게 결제 주기마다 적용되는 크레딧 한도입니다",
      overagePolicy: "초과 정책",
      overagePolicyDescription: "멤버가 월별 한도에 도달하거나 기업 요금제 크레딧이 소진된 후의 처리 방식입니다",
      overageBlock: "호출 차단",
      overageUseBalance: "기업 잔액 계속 사용",
      savePolicy: "정책 저장",
      policySaved: "기업 사용량 정책이 업데이트되었습니다",
      policyLoadFailed: "기업 사용량 정책을 불러오지 못했습니다",
      policySaveFailed: "기업 사용량 정책을 저장하지 못했습니다",
      enterprisePermissionRequired: "기업 관리자 또는 소유자 권한이 필요합니다",
      creditUnit: "크레딧 / 월",
    },
    apiDocument: "API 문서",
    name: "워크스페이스 이름",
    ...
    storage: {
      ...
      usedLabel: "사용된 저장소",
      usedDescription: "현재 워크스페이스에서 이미 사용한 저장 공간",
      remainingLabel: "남은 저장소",
      remainingDescription: "현재 할당량에서 아직 사용할 수 있는 저장 공간",
      usageLabel: "저장소 사용률",
      usageDescription: "저장 스페이스의 사용 백분율",
      unlimited: "무제한",
      usedOfUnlimited: "{used} 사용됨",
      statusOk: "정상",
      statusWarning: "한도 근접",
      statusExceeded: "할당량 초과",
      statusUnlimited: "무제한",
      warningHint: "현재 워크스페이스 사용률이 {threshold} 경고선에 도달했습니다. 저장소 할당량 증설이 필요한지 관리자에게 문의하세요.",
      exceededHint: "현재 워크스페이스가 저장소 할당량을 초과했습니다. 업로드나 가져오기를 계속하려면 관리자에게 할당량 증설을 요청하세요.",
    },
    leaveDangerZone: {
      title: "이 스페이스 나가기",
  ...
  createChat: {
    title: "안녕하세요, 睿乐大脑입니다 — 당신의 지식을 손끝에",
  ...
  knowledgeList: {
    ...
    emptyShared:
      "협업 지식베이스가 없습니다. 현재 워크스페이스가 팀 스페이스에 참여하면 여기에 표시됩니다.",
    empty: {
      title: "지식베이스 없음",
      description:
      ...
      sharedDescription:
        "팀 스페이스 관리자가 현재 워크스페이스를 추가하거나 다른 사람이 지식베이스를 직접 공유하면 여기에 표시됩니다.",
      favoritesTitle: "즐겨찾기 없음",
      favoritesDescription: "카드의 별표 아이콘을 눌러 즐겨찾기에 추가하세요",
      recentsTitle: "최근 항목 없음",
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      icon: "아이콘",
      iconUpload: "이미지 업로드",
      iconImageInvalid: "이미지 파일을 선택하세요",
      iconImageTooLarge: "이미지는 {size}MB 이하여야 합니다",
      iconImageProcessFailed: "이미지 처리에 실패했습니다",
      typeLabel: "지식베이스 유형",
      typeDocument: "문서",
      typeFAQ: "Q&A",
      typeDescription:
        "FAQ 유형은 구조화된 Q&A 데이터에 적합합니다. 문서 유형은 파일 파싱과 청킹을 지원합니다. Wiki 유형은 LLM을 통해 상호 연결된 지식 페이지를 자동으로 구축합니다.",
      createScopeLabel: "지식베이스 소속",
      createScopeDescription: "지식베이스가 관리될 위치를 선택합니다. 개인 지식베이스는 본인만 볼 수 있고, 기업 지식베이스는 기업 공간에서 관리됩니다.",
      createScopePersonal: "개인 지식베이스",
      createScopeEnterprise: "기업 지식베이스",
      enterpriseTargetLabel: "기업 공간",
      enterpriseTargetPlaceholder: "기업 공간을 선택하세요",
      enterpriseTargetRequired: "기업 공간을 선택하세요",
      nameLabel: "지식베이스 이름",
  ...
  organization: {
    title: "팀 스페이스",
    subtitle:
      "팀 스페이스를 만들고 관리자가 참여 워크스페이스를 추가하여 지식베이스와 에이전트를 공유하세요.",
    createOrg: "스페이스 생성",
    ...
    rbac: {
      ...
      enterpriseOnly: "팀 공간은 엔터프라이즈 워크스페이스에서만 사용할 수 있습니다.",
      cannotCreate: "현재 워크스페이스 역할이 부족하여 팀 공간을 만들 수 없습니다",
      cannotJoin: "현재 워크스페이스 역할이 부족하여 팀 공간 참여를 관리할 수 없습니다",
      cannotManage: "현재 워크스페이스 역할이 부족하여 팀 공간을 관리할 수 없습니다",
    },
    invite: {
    ...
    empty: "아직 팀 스페이스를 생성하지 않았습니다.",
    emptyDesc: "팀 스페이스를 생성하면 소유자가 되어 구성원을 초대할 수 있습니다.",
    all: "모두",
    createdByMe: "내가 생성한",
    joinedByMe: "내가 참여한",
    createdTag: "생성",
    ...
    emptyCreated: "아직 팀 스페이스를 만들지 않았습니다.",
    emptyCreatedDesc: '새 스페이스를 만들려면 "스페이스 만들기"를 클릭하세요.',
    emptyJoined: "아직 팀 스페이스에 참여하지 않았습니다.",
    emptyJoinedDesc: "팀 스페이스 관리자가 현재 워크스페이스를 추가할 때까지 기다리세요.",
    role: {
      admin: "관리자",
      editor: "편집자",
      viewer: "읽기 전용",
    ...
    settings: {
      ...
      noSharedKBTip:
        "‘지식베이스 추가’를 클릭하여 현재 기업 워크스페이스의 지식베이스를 선택하고 공유하세요.",
      addKnowledgeBase: "지식베이스 추가",
      addKnowledgeBaseDialogTitle: "기업 지식베이스 추가",
      addKnowledgeBaseDialogDesc: "현재 기업 워크스페이스에서 지식베이스를 선택하여 이 팀 스페이스에 공유하세요.",
      addKnowledgeBaseSearchPlaceholder: "지식베이스 이름 또는 설명 검색",
      addKnowledgeBaseEmpty: "현재 기업 워크스페이스에 추가할 수 있는 지식베이스가 없습니다.",
      addKnowledgeBaseSelected: "{count}개 지식베이스 선택됨",
      addKnowledgeBaseConfirm: "추가 및 공유",
      addKnowledgeBaseSuccess: "{count}개의 지식베이스를 추가했습니다.",
      addKnowledgeBasePartialSuccess: "{success}개의 지식베이스를 추가했으며 {failed}개는 실패했습니다.",
      addKnowledgeBaseFailed: "지식베이스를 추가하지 못했습니다. 다시 시도해 주세요.",
      addKnowledgeBaseLoadFailed: "기업 지식베이스를 불러오지 못했습니다. 다시 시도해 주세요.",
      addAgent: "에이전트 추가",
      addAgentDialogTitle: "기업 에이전트 추가",
      addAgentDialogDesc: "현재 기업 워크스페이스에서 에이전트를 선택하여 이 팀 스페이스에 공유하세요.",
      addAgentSearchPlaceholder: "에이전트 이름 또는 설명 검색",
      addAgentEmpty: "현재 기업 워크스페이스에 추가할 수 있는 에이전트가 없습니다.",
      addAgentSelected: "{count}개 에이전트 선택됨",
      addAgentConfirm: "추가 및 공유",
      addAgentSuccess: "{count}개의 에이전트를 추가했습니다.",
      addAgentPartialSuccess: "{success}개의 에이전트를 추가했으며 {failed}개는 실패했습니다.",
      addAgentFailed: "에이전트를 추가하지 못했습니다. 다시 시도해 주세요.",
      addAgentLoadFailed: "기업 에이전트를 불러오지 못했습니다. 다시 시도해 주세요.",
      ...
      noSharedAgentsTip: "‘에이전트 추가’를 클릭하여 현재 기업 워크스페이스에서 에이전트를 선택하고 공유하세요.",
    ...
    addMember: {
      button: "워크스페이스 추가",
      dialogTitle: "워크스페이스 추가",
      tip: "구성원 관리 데이터에서 대표 구성원을 선택하세요. 권한은 해당 구성원의 워크스페이스를 통해 부여되므로 같은 워크스페이스의 사용자는 접근 권한을 공유합니다.",
      ...
      searchPlaceholder: "구성원 이름 또는 휴대폰 번호로 검색...",
      searchTenantPlaceholder: "워크스페이스 이름, 사용자 이름 또는 휴대폰 번호로 검색...",
      searchHint: "기본 목록은 구성원 관리의 활성 구성원입니다. 이름 또는 휴대폰 번호로 검색하려면 2자 이상 입력하세요.",
      searchTenantHint: "2자 이상 입력하세요. 결과는 워크스페이스 기준으로 중복 제거되며 이미 가입한 워크스페이스는 제외됩니다.",
      alreadyInSpace: "워크스페이스가 이미 가입됨",
      selectRole: "역할 할당",
      confirmBtn: "추가",
      success: "회원이 추가되었습니다.",
      failed: "추가 실패",
  ...
  kbSettings: {
    vectorStore: {
      ...
      engineLabel: "벡터 스토어",
      engineDesc:
        "전역 벡터 스토어 설정에서 등록한 스토어를 선택하거나, '시스템 기본값'을 유지하면 워크스페이스의 RETRIEVE_DRIVER 엔진을 사용합니다.",
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: "지식베이스 전체 수명 주기를 관리할 수 있습니다: 생성, 복사, 수정, 삭제 및 초기화/설정 변경. 기존 지식베이스에 대한 작업(복사/수정/삭제)은 선택한 범위로 제한되며, 새 지식베이스 생성은 제한되지 않습니다(새 지식베이스는 이 스페이스에 속함).",
	      ...
	      capabilityManageModelsHint: "모델 설정, 자격 증명, 연결 테스트 및 睿乐大脑云 자격 증명을 관리합니다.",
	      ...
	      capabilityManageSpacesHint: "조직/공간, 가입 흐름, 공간 멤버, 초대 및 팀 공간 표시를 관리할 수 있습니다. 지식베이스 또는 에이전트 공유 관리는 부여하지 않습니다.",
      ...
      principalModeDesc:
        "API 요청이 최종 사용자를 어떻게 식별할지 설정합니다. 이 신원은 대화 Session과 MCP 도구 인증을 사용자별로 구분하며, API Key의 워크스페이스 관리자 권한은 바뀌지 않습니다.",
      principalScope:
        "최종 사용자별로 대화 Session과 MCP 도구 인증(OAuth)을 구분합니다. API Key는 여전히 워크스페이스 내 모든 지식베이스에 접근할 수 있으며, API 권한 범위는 외부 사용자별로 나뉘지 않습니다.",
      modeTenant: "워크스페이스만",
      ...
      signedFlowDetail:
        "HMAC secret은 睿乐大脑와 신뢰할 수 있는 백엔드에만 보관하세요. 요청에 넣거나 브라우저에 배포하지 마세요. 요청 헤더에는 secret이 아니라 해당 secret으로 서명한 JWT 문자열을 넣습니다(발급마다 또는 만료 후 변경). JWT에는 sub(외부 사용자 ID), tenant_id, aud=weknora, exp(최대 24시간)가 필요합니다.",
      directHeader: "사용자 ID 헤더",
      requireDirectHeader: "사용자 ID 헤더 필수",
      requireDirectHeaderDesc:
        "켜면 사용자 ID 헤더가 없는 API Key 요청을 거부하고, 끄면 워크스페이스 전체로 통일 처리하며 개별 사용자를 구분하지 않습니다.",
      tokenHeader: "토큰 헤더",
      tokenHeaderDesc: "클라이언트는 이 고정 헤더에 백엔드가 서명한 JWT를 전달합니다.",
      hmacSecret: "HMAC secret",
      hmacSecretDesc: "睿乐大脑에 저장된 것과 동일한 secret. 백엔드에서 JWT 서명에만 사용하며 요청 헤더로 보내지 않습니다.",
      ...
      signedRequestStep0:
        "# 0. 백엔드에서 JWT 서명 (HS256, aud=weknora, sub=사용자 ID, tenant_id={tenantId}, exp 최대 24시간)",
    ...
    claw: {
      title: "睿乐大脑 Skill",
      subtitle:
        "睿乐大脑 REST API로 문서를 가져오고 하이브리드 검색(벡터+키워드)을 수행합니다. 파일/URL/Markdown 업로드 및 검색에 사용.",
      ...
      steps: {
        ...
        install: {
          title: "Skill 설치",
          desc: "OpenClaw CLI가 설치된 환경에서 아래 명령을 실행하세요.",
        },
      ...
      ecosystemNote: "승인된 내부 배포 소스에서 Skill을 설치하세요.",
      installCta: "Skill 설치",
      installCtaHint: "睿乐大脑 Skill 설치 · 새 탭에서 열림",
      hubMeta: "내부 배포",
    },
  },
  imOverview: {
  ...
  tenantMember: {
    title: "멤버 관리",
    sectionDescription: "기업 워크스페이스의 모든 구성원을 초대하고 역할을 관리합니다. 소유자만 멤버를 추가하거나 제거할 수 있습니다.",
    ...
    create: {
      ...
      phoneLabel: "휴대폰 번호",
      phonePlaceholder: "휴대폰 번호 입력",
      passwordHint: "기본 비밀번호는 rl + 휴대폰 뒤 6자리입니다:",
      submit: "추가",
      success: "멤버를 추가했습니다. 기본 비밀번호: {password}",
    },
    remove: {
      button: "제거",
    ...
    workProfile: {
      ...
      shortButton: "분신 설정",
      edit: "분신 설명 편집",
      dialogTitle: "분신 설명 편집",
      jobLabel: "직무",
      jobPlaceholder: "직무 입력, 예: 원장, 입학 상담사, 교무 담당",
      label: "분신 설명",
      placeholder:
        "이 직원이 누구를 서비스하고, 무엇을 담당하며, 무엇을 담당하지 않는지, 서비스 경계와 읽을 수 있는 기억 범위를 설명하세요.",
      hint: "서비스 라우팅은 이 설명에서 역할, 서비스 대상, 책임, 권한 경계를 추출합니다.",
      empty: "미입력",
      suggest: "AI 자동 입력",
      suggestSuccess: "분신 설명이 생성되었습니다",
      suggestFailed: "분신 설명 생성 실패",
      jobRequired: "직무를 입력하세요",
      save: "설명 저장",
      success: "분신 설명이 저장되었습니다",
    },
    errors: {
      nameRequired: "이름을 입력하세요",
      ...
      phoneExists: "이 휴대폰 번호의 계정이 이미 있습니다.",
      nameExists: "이 이름의 계정이 이미 있습니다. 구분 가능한 이름을 사용하세요.",
      roleRequired: "역할을 선택하세요",
      workProfileRequired: "분신 설명을 입력하세요",
      userNotFound: "해당 휴대폰 번호로 가입된 사용자가 없습니다. 먼저 가입을 요청하세요.",
      alreadyMember: "이미 이 워크스페이스의 멤버입니다.",
      enterpriseMembershipExists: "이 사용자는 이미 다른 엔터프라이즈 워크스페이스에 속해 있어 다른 기업에 중복 가입할 수 없습니다.",
    ...
    audit: {
      tabLabel: "감사 로그",
      description:
        "이 워크스페이스의 멤버 변경 및 접근 거부 이벤트를 최신순으로 기록합니다. 1분 이내의 반복 거부는 자동으로 중복 제거됩니다.",
      refresh: "새로고침",
      loadMore: "이전 항목 더 보기",
      end: "마지막 항목입니다.",
      empty: "감사 이벤트가 없습니다.",
      ...
      action: {
        ...
        "rbac.member_profile_changed": "분신 설명 변경",
  ...
  tenantInvitation: {
    ...
    confirmInviteBody: "{phone} 번호로 초대를 보냅니다(역할: {role}). 수락 후 멤버가 됩니다.",
    confirmSend: "보내기",
    copyLink: "초대 링크 복사",
    copied: "클립보드에 복사됨",
    ...
    shareLink: {
      ...
      description:
        "여러 명이 사용할 수 있는 가입 링크를 생성합니다. 받은 사람이 자신의 이메일로 가입하고 이 워크스페이스에 합류합니다. {days}일 후 만료되며, 목록에서 언제든지 취소할 수 있습니다.",
      generate: "링크 생성",
