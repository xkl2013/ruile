export default {
  ...
  agent: {
    ...
    empty: {
      ...
      sharedDescription:
        "공유 스페이스 관리자가 현재 워크스페이스를 추가하거나 다른 사람이 에이전트를 직접 공유하면 여기에 표시됩니다.",
  ...
  knowledgeList: {
    ...
    emptyShared:
      "협업 지식베이스가 없습니다. 현재 워크스페이스가 공유 스페이스에 참여하면 여기에 표시됩니다.",
    empty: {
      title: "지식베이스 없음",
      description:
      ...
      sharedDescription:
        "공유 스페이스 관리자가 현재 워크스페이스를 추가하거나 다른 사람이 지식베이스를 직접 공유하면 여기에 표시됩니다.",
      favoritesTitle: "즐겨찾기 없음",
      favoritesDescription: "카드의 별표 아이콘을 눌러 즐겨찾기에 추가하세요",
      recentsTitle: "최근 항목 없음",
  ...
  organization: {
    title: "공유 스페이스",
    subtitle:
      "공유 스페이스를 만들고 관리자가 참여 워크스페이스를 추가하여 지식베이스와 에이전트를 공유하세요.",
    createOrg: "스페이스 생성",
    ...
    rbac: {
      ...
      cannotJoin: "현재 워크스페이스 역할이 부족하여 공유 공간 참여를 관리할 수 없습니다",
    ...
    emptyJoinedDesc: "공유 스페이스 관리자가 현재 워크스페이스를 추가할 때까지 기다리세요.",
    role: {
      admin: "관리자",
      editor: "편집자",
      viewer: "읽기 전용",
