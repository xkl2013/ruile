export default {
  ...
  organization: {
    ...
    addMember: {
      button: "회원 추가",
      dialogTitle: "회원 추가",
      tip: "사용자 목록에서 구성원을 선택하세요. 권한은 해당 사용자의 워크스페이스를 통해 부여되므로 같은 워크스페이스의 사용자는 접근 권한을 공유합니다.",
      ...
      searchPlaceholder: "사용자 이름 또는 휴대폰 번호로 검색...",
      searchTenantPlaceholder: "워크스페이스 이름, 사용자 이름 또는 휴대폰 번호로 검색...",
      searchHint: "목록에서 선택하거나 2자 이상 입력하여 검색하세요.",
