...
const emit = defineEmits<{
  ...
  (e: 'action', action: 'edit' | 'view-trace' | 'reparse' | 'regenerate-summary' | 'cancel-parse' | 'move' | 'batch-manage' | 'delete', item: KnowledgeCard): void;
...
// --- Action handlers ---
const handleAction = (action: 'edit' | 'view-trace' | 'reparse' | 'regenerate-summary' | 'cancel-parse' | 'move' | 'batch-manage' | 'delete', item: KnowledgeCard) => {
      ...
      <div class="card-content">
            ...
            <template #content>
              ...
              <div v-if="moveMenuMode === 'normal'" class="card-menu">
                <DocumentActionMenu
                  ...
                  @regenerate-summary="handleAction('regenerate-summary', item)"
        ...
        <div v-else-if="item.parse_status === 'failed'" class="card-analyze failure card-analyze-trace">
          ...
          <span
            ...
            role="button"
            tabindex="0"
            :title="item.error_message || $t('knowledgeStages.viewTrace')"
            @click.stop="handleAction('view-trace', item)"
            @keydown.enter.stop="handleAction('view-trace', item)"
            @keydown.space.prevent.stop="handleAction('view-trace', item)"
