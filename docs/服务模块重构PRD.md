...
| `KB_NOT_ACCESSIBLE` | 403 | 引用了无权访问的知识库 |
...
| 接口层 | `internal/handler/service.go` | 改造：新增服务 CRUD、成员、邀请、专家绑定、事项协作（负责人 / 子任务 / 评论 / 历史）、事项状态机与字段选项接口 |
